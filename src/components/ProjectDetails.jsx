...
const ProjectDetails = ({ project, onClose }) => {
  ...
  useEffect(() => {
    if (isPresent) {
      ...
      rootRef.current.style.overflowY = 'auto';
    } else {
              ...
              >
                <Flex direction="column" align="flex-start" py={ { base: 10, md: 5 } } px={ { base: 8, md: 10 } }>
                  <Flex align="center" justify="space-between" w="full">
                    <Box>
                      <Text fontSize="sm" fontWeight="medium" color="GrayText" textTransform="uppercase" lineHeight="1">
                        { project.category }
                      </Text>
                  ...
                  <Text mt="6">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Incidunt quaerat consectetur odit ea quia
