...
const Icon = ({ width = 20 }) => {
  return (
    ...
    >
      ...
      <g fill="#589F58">
        <path d="M160 80H48C21.6 80 0 99.2 0 126.4v243.2C0 396.8 21.6 416 48 416h112V80zM448 80H336v336h112c26.4 0 48-19.2 48-46.4V126.4c0-27.2-21.6-46.4-48-46.4z"></path>
      </g>
      <path
        fill="#479347"
